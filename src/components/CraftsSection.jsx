  ...
  return (
    ...
    <div className="w-full flex h-[1780px] items-center justify-center px-[77px] max-sm:px-[18px] max-xmd:h-[1317px] max-md:h-[1061px] max-sm:h-[717px]">
      ...
      <div className=" flex flex-col items-center justify-center gap-[64px]  max-md:gap-[14px]">
        <div className="flex flex-row   h-[213px] w-screen max-w-[88.54%] px-[10px] py-[10px] justify-between items-center gap-[128px]  max-xmd:gap-[0] max-xmd:max-w-[91.99%] max-md:max-w-[94.9%] max-sm:max-w-[388px] max-sm:h-[94px]">
          ...
          <div className="">
            {/* Line */}
            <p className="text-[#8490A1] max-md:hidden font-raleway max-w-[581px] w-screen text-[24px] text-right leading-[28px] max-xmd:text-[16px] max-md:text-[15px] max-xmd:leading-[150%] max-xmd:max-w-[461px] max-md:max-w-[244px] max-sm:text-[12px] max-xmd:leading-[120%] max-sm:max-w-[158px] max-sm:hidden">
        ...
        <div className="w-full flex justify-center py-[10px] px-[10px] ">
          <div className="flex flex-col   w-full items-center gap-[36px] max-xmd:gap-[64px] max-md:gap-[14px] max-sm:gap-[29px]">
            {/* Left column - Single image */}
            <div className=" h-[600px]  max-w-[88.54%] w-screen flex flex-row justify-center gap-[36px] max-xmd:h-[378px] max-xmd:max-w-[91.99%] max-xmd:gap-[33px] max-md:max-w-[94.9%] max-md:h-[322px] max-sm:max-w-[388px] max-sm:max-h-[180px]">
              <div
            ...
            <div className="max-w-[88.54%] w-screen flex flex-row justify-center gap-[36px]  max-xmd:max-w-[91.99%] max-xmd:gap-[33px] max-md:max-w-[94.9%] max-sm:max-w-[388px] max-sm:max-h-[180px]">
              <div
