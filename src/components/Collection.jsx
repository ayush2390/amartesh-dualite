...
const Collection = () => {
  ...
  return (
    <div className="flex items-center w-full justify-end h-full py-[90px] pl-[68px] max-xmd:pl-[0] max-md:justify-end max-md:pl-[45px] max-sm:pl-[10px]">
      <div className="w-screen h-full gap-[93px] max-w-[95.3%]  flex items-center flex-row justify-between max-md:flex-col max-md:justify-center max-md:items-start max-xmd:max-w-[95.3%]  max-sm:max-h-[576px] max-md:h-[886px] max-md:gap-[45px]">
        {/* Left Content */}
        <div className="w-full  max-w-[40.6%] flex flex-col gap-[36px] max-md:gap-[0]  justify-between  max-md:items-center max-sm:max-w-full max-sm:pr-[20px] max-md:pr-[40px] max-md:max-w-full max-xmd:max-w-[41.7%] max-md:flex-row ">
          <h1 className="text-[64px] font-bold text-[#0000000] font-raleway text-left leading-[120%] max-md:text-[40px] max-xmd:text-[48px] max-sm:text-[24px]">
        ...
        {/* Right Images */}
        <div className="flex w-full h-[592px] gap-[32px] pr-[10px]">
            <div
            ...
            >
              <div
                ...
                transform -translate-x-1/2 -translate-y-1/2 rotate-[-90deg] top-[90%] left-[8%] whitespace-nowrap max-md:left-[15%] max-xmd:top-[90%] max-sm:text-[20px] max-sm:top-[80%]`}
                style={{
            ...
            >
              <div
                ...
                transform -translate-x-1/2 w-[48px] -translate-y-1/2 rotate-[-90deg] top-[89%] left-[12%] whitespace-nowrap max-md:left-[25%] max-xmd:top-[90%] max-sm:text-[20px] max-sm:top-[87%]`}
                style={{
                  textShadow: "4px 4px 5.8px rgba(0, 0, 0, 0.54)", // Text shadow isn't directly available in Tailwind
                }}
              >
            ...
            >
              <div
                className={`relative font-raleway font-bold text-white text-[32px] max-md:text-[40px] 
                transform -translate-x-1/2 w-[48px] -translate-y-1/2 rotate-[-90deg] top-[89%] left-[12%] max-xmd:top-[90%] max-md:left-[25%] max-sm:text-[20px] max-sm:top-[87%]`}
                style={{
                  textShadow: "4px 4px 5.8px rgba(0, 0, 0, 0.54)", // Text shadow isn't directly available in Tailwind
                }}
              >
